...
function NavBar({ basket }: NavBarProps)
{
    ...
    const linkToBasket = () => {
        if (basket.length > 0) {
            return (
                <img src={RedPoint} alt="RedPoint" className={styles['nav-bar__red-point']} />
            )
        } 
        else
            return (
                <img src={RedPoint} alt="RedPoint" className={styles['nav-bar__red-point']} style={{ opacity: '0' }}/>
            )
    }
    ...
    return(
        <div className={styles['nav-bar']}>
            ...
            <button className={styles['nav-bar__button']} style={{ marginLeft: '2%', display: 'flex', maxWidth: '46px', maxHeight: '36px'}} onClick={handleBasketClick}>
                ...
                {linkToBasket()}
                <svg xmlns="http://www.w3.org/2000/svg" className={styles['.nav-bar__search-basket']} style={{ marginTop: '22.7%', maxHeight: '36px', paddingLeft: '15%' }}>  
