...
function NavBar()
{
    ...
    return(
        <div className={styles['nav-bar']}>
            ...
            <button className={styles['nav-bar__button']} style={{ marginLeft: '2%', display: 'flex', maxWidth: '46px', maxHeight: '36px'}}>
                <svg xmlns="http://www.w3.org/2000/svg" className={styles['.nav-bar__search-basket']} style={{ marginTop: '9%', maxHeight: '36px' }}>
                ...
                {/* Для анимации разделил */}
                <svg xmlns="http://www.w3.org/2000/svg" className={styles['.nav-bar__search-basket']} style={{ marginTop: '22.7%', maxHeight: '36px' }}>  
                    <path d="M13 1L7 6L1 1" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            </button>
            <button className={styles['nav-bar__start-button']}>Get Started</button>
        </div>
    )   
}
